...
本组织承载高考业务线的应用代码、数据资产、运营知识和部署编排；集团级战略和跨 BU 治理归 `President-Office`，通用平台底座、clone-bot、codegen-bot 归 `Business-Unit-for-Platform`。
...
- **通用能力**：可复用脚手架、clone-bot、codegen-bot、平台基础设施归 `Business-Unit-for-Platform`。
